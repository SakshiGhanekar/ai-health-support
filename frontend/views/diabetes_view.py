...
""", unsafe_allow_html=True)
    ...
    with col1:
        ...
        hba1c = st.number_input("HbA1c Level (From Lab Report)", 0.0, 15.0, 5.5)
    ...
    with col2:
        ...
        with st.expander("Additional Health Factors", expanded=False):
            ...
            gen_health = st.slider("General Health Rating", 1, 5, 3)
    ...
    if st.button("Run Screening Analysis", type="primary", use_container_width=True):
        ...
        inputs = {
            ...
            "smoking_history": 0 if smoking == "never" else 1,
            "bmi": bmi,
            "HbA1c_level": hba1c,
            "glucose": glucose,
